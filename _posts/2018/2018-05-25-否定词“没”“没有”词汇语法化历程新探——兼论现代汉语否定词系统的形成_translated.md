---
layout: post
title: "A New Exploration of the Lexical Grammaticalization of the Negators Mei and Meiyou: Also on the Formation of the Modern Chinese Negation System"
approx_date: "2018-05"
tags: [Linguistics]
lang: en
is_translation: true
...
## 2. The lexical grammaticalization trajectory of “没”
...
As for the time when Ad没 emerged, some scholars hold different views. Wu Fuxiang (1995) holds that Ad没 first appeared in the Southern Song, and cites five examples from *Zhang Xie Zhuangyuan* to argue that the use of “没” to negate the prior occurrence of an action or state had already emerged. However, according to our examination of the entire *Zhang Xie Zhuangyuan* and Wu Fuxiang’s five examples, among the instances in which “没” is followed by a predicative component, only one can be regarded as an example of Ad没 (setting aside the influence of the aspect marker “过”); the rest are all the special-context uses of V没 described above:
...
## 3. The lexical grammaticalization trajectory of “没有”
...
## 4. The general negative adverbial use of “没”
...
<a id="ref1">[1] The original book’s editor and annotator notes: “没文”: there is no such provision in the law. “膝下没黄金”: in contrast to “男儿膝下有黄金” (“a real man has gold beneath his knees”), meaning that one should be humble and deferential to others.</a> [↩](#cite1)

<a id="ref2">[2] The four *Lao Qida* editions used in this paper, in chronological order, are *Lao Qida*, *Lao Qida Eonhae*, *Lao Qida Xinshi*, and *Chongkan Lao Qida*, all taken from the appendix “Sentence-by-sentence comparison of four editions of *Lao Qida*” in Li Taesu (2003). Citations are marked afterward in accordance with the original book’s format.</a> [↩](#cite2)

<a id="ref3">[3] In the Early Modern Chinese Corpus there are quite a few mistagging cases in annotating the negative adverbs “无” and “没”. After verification, most instances of the negative adverb “无” are still actually the verb usage (mainly used in double-negative sentences), and thus are all classified under the verb “无”. As for the negative adverb “没”, in northern works most are Ad 没 and mistagging is very rare, so we retain the original data; in southern works mistagging is more common, so we rechecked these and marked them on the left side of the slash in the relevant data in the table above. Due to limited time and energy, statistical errors are unavoidable, but we believe the table above is basically sufficient to reflect the north–south differences in the use of “没” and “无”.</a> [↩](#cite3)

<a id="ref4">[4] Here, following Lü Shuxiang’s criterion, the history of Chinese before the period of Early Modern Chinese is collectively referred to as Ancient Chinese, but in terms of time we take the 7th century, i.e., the early Tang, as the boundary.</a> [↩](#cite4)

<a id="ref5">[5] After the “没”-series negatives had formed, the affixation tendency of the negative “没” became increasingly evident. As for Modern Chinese, although in terms of intuition “没” and “没有” are basically freely interchangeable, according to our investigation of three tagged Modern Chinese corpora, in spoken language “没” still has a slight advantage and is used more frequently than “没有”, but in written language the frequency of “没有” has comprehensively surpassed “没”. As for the use of “没”, in both spoken and written language, Ad 没 is used more frequently than V 没. The use of V 没 is relatively quite restricted; compare: “\*钱我没” and “钱我没有”. According to Li Yan (2010), “没” even shows a tendency to gradually change toward a sentence-final modal particle.</a> [↩](#cite5)

<a id="ref6">[6] According to Zhou Jian (2003:152), based on an exhaustive count of 32,346 disyllabic words, 96.57% of Modern Chinese “disyllabic composite units” can be organized and explained by applying syntactic-structure patterns. Although the “syntactic structures” here are not entirely “subject–predicate, coordinate, modifier–head, verb–object, verb–complement”, these major Chinese syntactic structures are undoubtedly the most important components.</a> [↩](#cite6)



## References

- Wang Fanzhi 1991 *Wang Fanzhi shi jiaozhu*, annotated by Xiang Chu, Shanghai: Shanghai Ancient Books Publishing House.
- Cai Meibiao 1955 *Yuan-dai baihua bei ji lu*, Beijing: Science Press.
- Li Taesu 2003 *A Linguistic Study of Four Editions of <Lao Qida>*, Beijing: Language Press.
- Pan Wuyun 2002 “An Etymological Study of Chinese Negative Words—Also on Basic Methods for Investigating the Original Characters of Function Words,” *Zhongguo Yuwen*, No. 4.
- Ota Tatsuo 2003 *A Historical Grammar of Chinese*, translated by Jiang Shaoyu and Xu Changhua, Beijing: Peking University Press.
- Kōsaka Jun’ichi 1997 *Studies on Vernacular Vocabulary*, Beijing: Zhonghua Book Company.
- Liu Jian, Cao Guangshun, Wu Fuxiang 1995 “On Several Factors Triggering the Grammaticalization of Chinese Lexicon,” *Zhongguo Yuwen*, No. 3.
- Zhang Yisheng 2003 “On the Mechanisms of Grammaticalization Related to Chinese Adverbs—Also on the Nature, Classification, and Scope of Modern Chinese Adverbs,” *Zhongguo Yuwen*, No. 1.
- Lü Shuxiang 2002 *The Complete Works of Lü Shuxiang*, Vol. 5, *800 Words in Modern Chinese*, Shenyang: Liaoning Education Press.
- Shen Jiaxuan 1994 “An Overview of Studies on ‘Grammaticalization’,” *Foreign Language Teaching and Research*, No. 4.
- Shi Yuzhi 2001 *Symmetry and Asymmetry of Affirmation and Negation*, Beijing: Beijing Language and Culture University Press.
- Xu Shiyi 2003 “The Origin and Grammaticalization Process of the Negative Words ‘没’ and ‘没有’,” *Journal of Huzhou Teachers College*, No. 1.
- Wu Fuxiang 1995 “The Negative Adverb ‘没’ First Appeared in the Southern Song,” *Zhongguo Yuwen*, No. 2.
- Yang Rongxiang 1999 “A Brief Discussion of Negative Adverbs in Early Modern Chinese and Related Grammatical Phenomena,” *Language Research*, No. 1.
- Mei Tsu-lin 1984 “Dating the Composition of the Spoken Parts in Several Yuan Zaju Plays from the Perspective of Language History,” *Linguistics Series*, Vol. 13.
- Harris, Alice C., Lyle Compbell 1995 *Historical Syntax in Cross-linguistic Perspective*. Cambridge: Cambridge University.
- Lin Lunlun 1984 “Speaking,” *Guangzhou Studies*, No. 4.
- Hashimoto Mantaro 1985 *Linguistic Geographical Typology*, Beijing: Peking University Press.
- Zhang Min 2002 Unpublished manuscript, “The ‘Negation–Existence Evolutionary Cycle’ in Old Chinese, Middle Chinese, and Modern Southern Chinese Dialects.”
- Xiang Xi 1998 *A Concise History of Chinese (Part II)*, Beijing: Higher Education Press.
- Dong Xiufang 2002 *The Derivation and Development of Chinese Disyllabic Words*, Chengdu: Sichuan Nationalities Publishing House.
- Li Yan 2010 “The Gradual Change of Sentence-final ‘没’ from a Negative Adverb to an Interrogative Modal Particle,” *Journal of Shenzhen University (Humanities & Social Sciences)*, No. 4.
- Hu Churui 2005 “From Implicitness to Explicitness (I)—On an Essential Change in Medieval Vocabulary,” *Linguistics Series*, Vol. 31.
- Hu Churui 2008 “From Implicitness to Explicitness (II)—On an Essential Change in Medieval Vocabulary,” *Linguistics Series*, Vol. 38.
- Shi Yuzhi, Li Ne 2000 “Syntactic Changes Around the Fifteenth Century and the Formation of the Modern Chinese Negation-marker System—The Syntactic Background for the Emergence of the Negative Marker ‘没(有)’ and Its Grammaticalization Process,” *Language Research*, No. 2.
- Dai Hao-yi 2002 “Conceptual Structure and Non-autonomous Grammar: A Preliminary Exploration of the Conceptual System of Chinese Grammar,” *Contemporary Linguistics*, No. 1.
- Zhou Jian 2003 “On the Composition, Structure, and Status of Words,” *Zhongguo Yuwen*, No. 2.
