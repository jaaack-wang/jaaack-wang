...
\section{Publications \& Manuscripts}
  ...
  \resumeSubHeadingListStart
    ...
    \textcolor{gray}{(* denotes equal contributions)} \\ \vspace{2pt}
    	$\cdot$ \textbf{Wang, Z.} (2023). \href{https://aclanthology.org/2022.icnlsp-1.5/}{Alignment Learning with RNN Seq2seq Models.} \emph{Manuscript to appear as a preprint}. \\ \vspace{2pt}
