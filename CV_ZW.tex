...
\section{Publications \& Manuscripts}
  ...
  \resumeSubHeadingListStart
    ...
    \textcolor{gray}{(* denotes equal contributions)} \\ \vspace{2pt}
        ...
        $\cdot$ \textbf{Wang, Z.} (2022). \href{https://arxiv.org/abs/2209.00797}{Random Text Perturbations Work, but not Always.}  \emph{Proceedings of the 3rd Workshop on Evaluation and Comparison of NLP Systems}. \\ \vspace{2pt}
...
\section{Projects}
    ...
    \resumeProjectHeading
        {\textbf{RNN Seq2seq Models With Attention Are In-distribution Learners} $|$ \emph{\href{https://github.com/jaaack-wang/rnn-seq2seq-learning}{\color{blue}GitHub}}}{2022 \textbf{--} Present}
          \resumeItemListStart
            \resumeItem{Designed and conducted comprehensive experiments examining the capabilities of RNN seq2seq models in learning non-regular language transduction tasks for in-distribution \& out-distribution test data, given limited training data}
          \resumeItemListEnd
    ...
    \resumeProjectHeading
        ...
        $|$ \emph{\href{https://arxiv.org/abs/2208.03772}{\color{blue}Manuscript}}
        }{2022}
          \resumeItemListStart
            ...
            \resumeItem{Paper accepted by IEEE VIS 2022 and to appear on \emph{Transactions on Visualization and Computer Graphics}}
          \resumeItemListEnd
      ...
      \resumeProjectHeading
        ...
        $|$ \emph{\href{https://arxiv.org/abs/2111.14709}{\color{blue}Manuscript}}}{2021}
          \resumeItemListStart
