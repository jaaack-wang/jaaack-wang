...
\section{Projects}
    ...
    \resumeProjectHeading
        {\textbf{Alignments Learning with RNN Seq2seq models} $|$ \emph{\href{https://github.com/jaaack-wang/rnn-seq2seq-learning}{\color{blue}GitHub}}}{2022 \textbf{--} Present}
          \resumeItemListStart
...
\section{Tutorials}
    \resumeSubHeadingListStart
     ...
     \resumeProjectHeading
        {\textbf{rnn-transduction \& rnn-seq2seq-learning} $|$ \emph{\href{https://github.com/jaaack-wang/rnn-transduction}{\color{blue}Tutorial1}}
        $|$ \emph{\href{https://github.com/jaaack-wang/rnn-seq2seq-learning}{\color{blue}Tutorial2}}
        }{2023}
          \resumeItemListStart
